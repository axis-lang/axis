...
public class AxisParser extends Parser {
	...
	public static final int
		RULE_file = 0, RULE_statement = 1, RULE_valStatement = 2, RULE_pattern = 3, 
		RULE_tuplePattern = 4, RULE_tuplePatternElement = 5, RULE_expression = 6, 
		RULE_juxtapositionExpr = 7, RULE_logicalExpr = 8, RULE_comparisonExpr = 9, 
		RULE_addition = 10, RULE_product = 11, RULE_postfix = 12, RULE_primaryExpr = 13, 
		RULE_wildcard = 14, RULE_spread = 15, RULE_range = 16, RULE_tuple = 17, 
		RULE_tupleElement = 18, RULE_lambda = 19, RULE_semicolon = 20, RULE_lambdaParams = 21, 
		RULE_lambdaParam = 22, RULE_argument = 23, RULE_identifier = 24, RULE_literal = 25, 
		RULE_text = 26, RULE_decimal = 27;
	private static String[] makeRuleNames() {
		return new String[] {
			"file", "statement", "valStatement", "pattern", "tuplePattern", "tuplePatternElement", 
			"expression", "juxtapositionExpr", "logicalExpr", "comparisonExpr", "addition", 
			"product", "postfix", "primaryExpr", "wildcard", "spread", "range", "tuple", 
	...
	public final TuplePatternContext tuplePattern() throws RecognitionException {
		...
		enterRule(_localctx, 8, RULE_tuplePattern);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
	...
	public final TuplePatternElementContext tuplePatternElement() throws RecognitionException {
		...
		enterRule(_localctx, 10, RULE_tuplePatternElement);
		try {
			setState(101);
			_errHandler.sync(this);
	...
	public final JuxtapositionExprContext juxtapositionExpr() throws RecognitionException {
		...
		enterRule(_localctx, 14, RULE_juxtapositionExpr);
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
			{
	...
	public final LogicalExprContext logicalExpr() throws RecognitionException {
		...
		enterRule(_localctx, 16, RULE_logicalExpr);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 3:
						...
						_errHandler.sync(this);
						_la = _input.LA(1);
						if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 237600L) != 0)) {
							{
							setState(153);
							expression();
							setState(158);
	...
	public final SpreadContext spread() throws RecognitionException {
		...
		enterRule(_localctx, 30, RULE_spread);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(184);
	...
	public final TupleContext tuple() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 241696L) != 0)) {
				{
				setState(190);
				tupleElement();
				setState(195);
	...
	@SuppressWarnings("CheckReturnValue")
	public static class UnnamedTupleElementContext extends TupleElementContext {
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		public UnnamedTupleElementContext(TupleElementContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class NamedTupleElementContext extends TupleElementContext {
		public TerminalNode ID() { return getToken(AxisParser.ID, 0); }
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		public NamedTupleElementContext(TupleElementContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class DynamicTupleElementContext extends TupleElementContext {
		public List<ExpressionContext> expression() {
			return getRuleContexts(ExpressionContext.class);
		}
		public ExpressionContext expression(int i) {
		...
		public DynamicTupleElementContext(TupleElementContext ctx) { copyFrom(ctx); }
	}
	@SuppressWarnings("CheckReturnValue")
	public static class SpreadTupleElementContext extends TupleElementContext {
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
		public SpreadTupleElementContext(TupleElementContext ctx) { copyFrom(ctx); }
	}
	...
	public final TupleElementContext tupleElement() throws RecognitionException {
		...
		enterRule(_localctx, 36, RULE_tupleElement);
		try {
			setState(217);
			_errHandler.sync(this);
			switch ( getInterpreter().adaptivePredict(_input,22,_ctx) ) {
			case 1:
				_localctx = new UnnamedTupleElementContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(205);
				expression();
				...
				break;
			case 2:
				_localctx = new NamedTupleElementContext(_localctx);
				enterOuterAlt(_localctx, 2);
				{
				setState(206);
				match(ID);
				...
				break;
			case 3:
				_localctx = new DynamicTupleElementContext(_localctx);
				enterOuterAlt(_localctx, 3);
				{
				setState(209);
				match(T__12);
				...
				break;
			case 4:
				_localctx = new SpreadTupleElementContext(_localctx);
				enterOuterAlt(_localctx, 4);
				{
				setState(215);
				match(T__11);
	...
	public final SemicolonContext semicolon() throws RecognitionException {
		...
		enterRule(_localctx, 40, RULE_semicolon);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(250);
	...
	public final LambdaParamsContext lambdaParams() throws RecognitionException {
		...
		enterRule(_localctx, 42, RULE_lambdaParams);
		int _la;
		try {
			int _alt;
			enterOuterAlt(_localctx, 1);
	...
	public final LambdaParamContext lambdaParam() throws RecognitionException {
		...
		enterRule(_localctx, 44, RULE_lambdaParam);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
