...
def build_ast(self, _: syn.AxisParser.ModItemContext, path: syn.Expr):
...
def process_mod_scoping(self: sem.ScopingPass, mod_ast: Mod):
    # evaluar el path
    base_path_expr = transcript_sym_to_member_expressions(mod_ast.path, member_of=self.base_path_expr)
