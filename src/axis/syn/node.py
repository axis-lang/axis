...
class Node(Record, frozen=True, abstract=True):
    ...
    def __class_build__(proto: Type.Builder):
        ...
        def postbuild(cls: 'Node'):            
            from axis.syn.grammar import AxisParser
            from .building import AstBuilder
            #cls_name = proto.qualname or proto.name
            ctx_name = f'{proto.qualname.replace(".", "")}{cls.grammar_context_infix}Context'
    ...
    # TODO: property .repr_tree
    # la representacion natural sera la propia expresion
    def __rich__(self):
