...
class AxisParser ( Parser ):
    ...
    RULE_shape = 32
    RULE_element = 33
    RULE_valueElement = 34
    RULE_nominalElement = 35
    RULE_spreadElement = 36
    RULE_lambda = 37
    RULE_semicolon = 38
    ...
    ruleNames =  [ "unitItem", "modItem", "defItem", "valItem", "useBlock", 
                   ...
                   "prefix", "postfix", "primary", "symExpr", "lit", "tuple", 
                   "shape", "element", "valueElement", "nominalElement", 
                   "spreadElement", "lambda", "semicolon", "lambdaParams", 
                   "lambdaParam" ]
    ...
    class TupleContext(ParserRuleContext):
        ...
        def element(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(AxisParser.ElementContext)
            else:
                return self.getTypedRuleContext(AxisParser.ElementContext,i)
    ...
    def tuple_(self):
        ...
        self.enterRule(localctx, 62, self.RULE_tuple)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 284
    ...
    def shape(self):
        ...
        self.enterRule(localctx, 64, self.RULE_shape)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 300
    ...
    class ElementContext(ParserRuleContext):
        ...
        def valueElement(self):
            return self.getTypedRuleContext(AxisParser.ValueElementContext,0)


        def nominalElement(self):
            return self.getTypedRuleContext(AxisParser.NominalElementContext,0)


        def spreadElement(self):
            return self.getTypedRuleContext(AxisParser.SpreadElementContext,0)


        def getRuleIndex(self):
            return AxisParser.RULE_element
    ...
    def element(self):
        ...
        localctx = AxisParser.ElementContext(self, self._ctx, self.state)
    ...
    class ValueElementContext(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def getRuleIndex(self):
            return AxisParser.RULE_valueElement

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterValueElement" ):
                listener.enterValueElement(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitValueElement" ):
                listener.exitValueElement(self)
    ...
    def valueElement(self):
        ...
        localctx = AxisParser.ValueElementContext(self, self._ctx, self.state)
        self.enterRule(localctx, 68, self.RULE_valueElement)
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 321
            self.expression()
    ...
    class NominalElementContext(ParserRuleContext):
        __slots__ = 'parser'
        ...
        def getRuleIndex(self):
            return AxisParser.RULE_nominalElement

        def enterRule(self, listener:ParseTreeListener):
            if hasattr( listener, "enterNominalElement" ):
                listener.enterNominalElement(self)

        def exitRule(self, listener:ParseTreeListener):
            if hasattr( listener, "exitNominalElement" ):
                listener.exitNominalElement(self)
    ...
    def nominalElement(self):
        ...
        localctx = AxisParser.NominalElementContext(self, self._ctx, self.state)
        self.enterRule(localctx, 70, self.RULE_nominalElement)
        try:
            self.state = 337
            self._errHandler.sync(self)
    ...
    class SpreadElementContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return AxisParser.RULE_spreadElement
    ...
    def spreadElement(self):
        ...
        localctx = AxisParser.SpreadElementContext(self, self._ctx, self.state)
        self.enterRule(localctx, 72, self.RULE_spreadElement)
        self._la = 0 # Token type
        try:
            self.enterOuterAlt(localctx, 1)
            self.state = 339
