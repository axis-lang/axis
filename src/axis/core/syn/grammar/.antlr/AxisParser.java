...
public class AxisParser extends Parser {
	...
	public static final int
		...
		RULE_tuple = 31, RULE_shape = 32, RULE_element = 33, RULE_valueElement = 34, 
		RULE_nominalElement = 35, RULE_spreadElement = 36, RULE_lambda = 37, RULE_semicolon = 38, 
		RULE_lambdaParams = 39, RULE_lambdaParam = 40;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"symExpr", "lit", "tuple", "shape", "element", "valueElement", "nominalElement", 
			"spreadElement", "lambda", "semicolon", "lambdaParams", "lambdaParam"
		};
	}
	...
	public static class ElementContext extends ParserRuleContext {
		...
		public NominalElementContext nominalElement() {
			return getRuleContext(NominalElementContext.class,0);
		}
	...
	public final ValueElementContext valueElement() throws RecognitionException {
		...
		enterRule(_localctx, 68, RULE_valueElement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(321);
	...
	@SuppressWarnings("CheckReturnValue")
	public static class NominalElementContext extends ParserRuleContext {
		public List<ExpressionContext> expression() {
			return getRuleContexts(ExpressionContext.class);
		}
		public ExpressionContext expression(int i) {
		...
		public NominalElementContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_nominalElement; }
	}

	public final NominalElementContext nominalElement() throws RecognitionException {
		NominalElementContext _localctx = new NominalElementContext(_ctx, getState());
		enterRule(_localctx, 70, RULE_nominalElement);
		try {
			setState(337);
			_errHandler.sync(this);
	...
	public final SpreadElementContext spreadElement() throws RecognitionException {
		...
		enterRule(_localctx, 72, RULE_spreadElement);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
